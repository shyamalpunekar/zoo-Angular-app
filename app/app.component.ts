...
export class AppComponent{
  ...
  masterAnimalList: Animal[] = [
    ...
    new Animal('./resources/images/giraffe.jpg',' giraffe', 'Gif', 5, ' The tallest mammals in the world. Over short distances, giraffes can run at speeds up to 35 mph. Giraffes only need to drink water once every couple of days. They get most of their water from their plant-based diet' ,'herbivorous', 'Herbivore', 2, 'Female', '', 'walking'),
