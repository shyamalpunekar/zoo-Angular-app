...
export class AppComponent{
  ...
  masterAnimalList: Animal[] = [
    new Animal('Siberian Tiger', 'Amur', 2, 'The gene for white coating is quite common among Bengal tigers, but the natural birth of a white Bengal tiger is still a very rare occasion in the wild, where white tigers are not bred selectively. The white tiger is not considered a tiger subspecies, but rather a hybrid mutant variant of the existing tiger subspecies.' ,'Carnivore', 'Bengal', 3, 'Female', 'cold weather', 'entertainment'),
    new Animal('Polo bear', 'Polo', 8, 'Polar bears are large, white bears that like cold climates, fatty meals and long days of hunting. No matter how adorable polar bears look, these animals are not cuddly. In fact, polar bears are ferocious hunters, and they are the biggest carnivores among land animals.' , 'Omnivore', 'Arctic Ocean', 5, 'Male', 'cold climates', 'heat'),
    new Animal(' giraffe', 'Gif', 5, ' The tallest mammals in the world. Over short distances, giraffes can run at speeds up to 35 mph. Giraffes only need to drink water once every couple of days. They get most of their water from their plant-based diet' ,'Herbivore', 'South Asia', 2, 'Female', '', 'walking'),
    new Animal('monkey', 'Monk', 1, ' Monkeys are one of the funniest animals in nature. They are full of curiosity and adventure, mischief and intelligence. A monkey would make a great science project because there are many different species that you could explore, and also, you could study how monkeys evolved into human beings.' ,'Herbivore', 'Atlanta', 1, 'Female', 'Physically and Socially Fitting in Dinner parties Meditating Training Respect', 'Being told what to do')
  ];
  selectedAnimal = null;
